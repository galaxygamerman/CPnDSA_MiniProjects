...
int main() {
    ...
    cout << "Input the no. of numbers in your password: ";
    cin >> nums.desiredDigits;
    cout << "Input the no. of symbols in your password: ";
    cin >> symbo.desiredDigits;
...
labelWhichType: // A label to allow me to loop the program according to how I intended. Trust me, for and while didn't work well
    ...
    case 1:
        ...
        // Numbers
    case 2:
        if (nums.printedDigits >= nums.desiredDigits)
            goto labelWhichType;
        ...
        // Symbols
    case 3:
        if (symbo.printedDigits >= symbo.desiredDigits)
            goto labelWhichType;
    ...
    default:
        cout << "[Debug for Dev]Wrong rand value in loop" << i << endl;
    }
    i = alphas.printedDigits + nums.printedDigits + symbo.printedDigits;

    if (i < totalDigits)
        goto labelWhichType; // To loop back
